    ...
    <div className="paper-bg min-h-screen w-full py-8 print:bg-white" style={{ fontFamily: "'Noto Sans Thai', sans-serif" }}>
      <div className="mx-auto max-w-md px-4">
        <div className="rounded-xl bg-white p-6 shadow-sm print:shadow-none">
          ...
          {/* total */}
          <div className="mt-3 flex items-center justify-between rounded-lg px-3 py-3" style={{ background: PAPER }}>
            <div>
              <p className="text-[11px] text-stone-500">ยอดรวมค่าเช่า ({nDays} วัน)</p>
            ...
            <span className="text-lg font-bold" style={{ color: RED, fontFamily: "'IBM Plex Mono', monospace" }}>{money(booking.total)}</span>
          </div>
