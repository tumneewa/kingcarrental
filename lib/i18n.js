...
export const translations = {
  ...
  depositNote: { th: "ยอดมัดจำ (ยอดรวมค่าเช่าทั้งหมด {total} ส่วนที่เหลือชำระตอนรับรถ)", en: "Deposit amount (total rental {total} — remainder due at pickup)", zh: "定金金额（总租金 {total}，余款取车时支付）" },
  ...
  attachSlip: { th: "แนบรูปสลิปโอนเงิน (ไม่บังคับ)", en: "Attach transfer slip (optional)", zh: "上传转账单（选填）" },
  ...
  afterPayHint: { th: "หลังโอนเงิน แนบรูปสลิป (ถ้ามี) แล้วกดปุ่มด้านบนเพื่อแจ้งให้ร้านทราบ พนักงานจะตรวจสอบและยืนยันอีกครั้ง", en: "After transferring, attach the slip (if any) and press the button above to notify us. Staff will verify and confirm.", zh: "转账后，请上传转账单（如有）并点击上方按钮通知我们，工作人员将核实并确认" },
